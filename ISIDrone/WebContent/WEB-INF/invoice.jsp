        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="invoice-title">
                    ...
                    %>
                    <h2>Facture</h2>
                    <h3 class="pull-right">Commande # <%=order.getId()%>
                    </h3>
                    <%
                    } else {
                    %>
                    <h2>Facture</h2>
                    <h3 class="pull-right">Commande # <%=(Integer) request.getAttribute("orderId")%>
                    </h3>
                    <%
                        }
                    %>
                        ...
                        <div class="table-responsive">
                            <table class="table table-condensed">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><%=df.format(itemC.getPrice())%>
                                    </td>
                                    <td class="text-center"><%=itemC.getQty()%>
                                    </td>
                                    <td class="text-right"><%=df.format(itemC.getPrice() * itemC.getQty())%>
                                    </td>
                                </tr>
                                <%
                                    }
