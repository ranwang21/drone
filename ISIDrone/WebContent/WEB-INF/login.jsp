...
<div class="container">
    ...
    <div class="panel panel-danger">
        ...
        <ul class="panel-body">
            ...
            %>
            <li style="margin-bottom: 0px; white-space: pre-line;"><%=hm_errorMsg.get("login")%>
            </li>
            <%
                }
            ...
            %>
            <li style="margin-bottom: 0px; white-space: pre-line;"><%=hm_errorMsg.get("password")%>
            </li>
            <%
                }
            } else if (hm_errorMsg != null && hm_errorMsg.get("loginState").equals("Account Deactivated")) {
            %>
            <li style="margin-bottom: 0px; white-space: pre-line;">Account is Deactivated</li>
            <% }%>
        </ul>
    </div>
    <%
        ...
        <div class="panel-body">
            <fieldset class="col-sm-10 col-lg-10 col-md-10">
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="login" class="form-control" name="login" placeholder="toto@gmail.com"
                           value="<%=Misc.getOrDefault(hm_login, "login", "")%>" required/>
                </div>
                <div class="form-group">
